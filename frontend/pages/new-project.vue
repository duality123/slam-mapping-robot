<template>
    <NuxtLayout name="base">
            ...
            <div class="container-fluid text-white mt-4  p-4">
              <ul class="d-flex justify-content-start bd-highlight mb-3" v-if="user.userData.roles.includes('1')">
                    ...
                    <li class="p-2">/</li>
                    <li class="p-2"><NuxtLink :to="`/new-project`" class="nav-link "  aria-current="page" href="#"><font-awesome-icon :icon="['fas', 'file']" class="me-3"/>New Project</NuxtLink></li>                
                  </ul>
  ...
  <div class="mb-3">
    ...
    <div id="emailHelp" class="form-text"><small v-if="dataProject['errors']['lokasi']"  class="text-danger text-small">{{ dataProject['errors']['lokasi'] }}</small></div>
    <div id="map"></div>
        ...
        methods:{
          ...
          changeModel(event){
            ...
            async postProject(){
              ...
              data.append('collaborators',this.user.userData['id']['$oid'])
            ...
            await $fetch(`${useRuntimeConfig().public.backendURL}/api/monitors/`, {
              ...
              .then(response => {
                this.dataProject['errors']={"k_pakan":"","deskripsi":"","project_id":"","lokasi":null,"model":""}
          ...
          onMapClick(e) {
            ...
            console.log(this.dataProject['lokasi'])
          }
      },
      components:{
        L
